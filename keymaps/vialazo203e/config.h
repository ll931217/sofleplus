...
// https://docs.qmk.fm/features/pointing_device#gesture-settings

/* azoteq config: extend drag time */
#define AZOTEQ_IQS5XX_HOLD_TIME 300 // Default 300
#define AZOTEQ_IQS5XX_SCROLL_INITIAL_DISTANCE 10 // Default 50

#define AZOTEQ_IQS5XX_SCROLL_ENABLE true // (Optional) Enable scrolling using two fingers.
...
#define AZOTEQ_IQS5XX_SWIPE_X_ENABLE false //(Optional) Enable swipe gestures X+ (Mouse Button 5) / X- (Mouse Button 4)
#define AZOTEQ_IQS5XX_SWIPE_Y_ENABLE false //(Optional) Enable swipe gestures Y+ (Mouse Button 3) / Y- (Mouse Button 6)
