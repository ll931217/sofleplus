...
[0] = LAYOUT(
  ...
  KC_LSFT,      KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_MUTE,        RGB_TOG,    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
                KC_LGUI,    KC_LALT,    KC_LCTL,    MO(1),      KC_SPC,                                 KC_ENT,     MO(2),      KC_RGUI,    KC_RALT,    KC_RCTL
),
...
[1] = LAYOUT(
  ...
  KC_LSFT,      KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
...
[2] = LAYOUT(
  ...
  _______,      _______,    _______,    _______,    _______,    _______,    _______,        _______,    LSFT(KC_MINS),  LSFT(KC_EQL),   LSFT(KC_LBRC),  LSFT(KC_RBRC),  LSFT(KC_BSLC),  LSFT(KC_GRV),
